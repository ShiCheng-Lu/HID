...
typedef struct {
    ...
    EndpointDescriptor_t KeyboardReportInEndpoint;
    EndpointDescriptor_t KeyboardReportOutEndpoint;

    // Mouse HID Interface
    InterfaceDescriptor_t MouseInterface;
    HIDDescriptor_t MouseHID;
    EndpointDescriptor_t MouseReportInEndpoint;
    EndpointDescriptor_t MouseReportOutEndpoint;
...
#define MOUSE_OUT_EPADDR (ENDPOINT_DIR_OUT | 4)
