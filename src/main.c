...
/** \file
 *
 *  Main source file for the KeyboardMouse demo. This file contains the main
...
bool CALLBACK_HID_Device_CreateHIDReport(
    ...
    if (HIDInterfaceInfo == &Keyboard_HID_Interface) {
        // KeyboardReport_t* KeyboardReport = (KeyboardReport_t*)ReportData;
        ...
        *ReportSize = sizeof(KeyboardReport_t);
        ...
        // MouseReport_t* MouseReport = (MouseReport_t*)ReportData;
